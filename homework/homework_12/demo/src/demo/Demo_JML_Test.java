/*
 * Test Oracle Class for demo.Demo
 * For Use With OpenJML RAC
 *
 * Generated by JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178), 2019-05-22 20:50 +0800.
 ...
 * @version 2019-05-22 20:50 +0800
 */

public /*@ nullable_by_default */ class Demo_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {Demo_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertTrue
    (Utils.isRACCompiled(demo.Demo.class),
   ...
   *
   * @param the_test_object The Demo to call the test method on.
  ...
  () {
    try {
      ...
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_Demo__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator(Demo_InstanceStrategy.class));
  }
}