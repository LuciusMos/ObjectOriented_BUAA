...
```bash
java -jar uml-homework-1.0.0-raw-jar-with-dependencies.jar list -s "open-close.mdj"
java -jar uml-homework-1.0.0-raw-jar-with-dependencies.jar list -s "pressure2-120layer.mdj"
```
...
```bash
java -jar uml-homework-1.0.0-raw-jar-with-dependencies.jar dump -s "open-close.mdj" -n Model1
java -jar uml-homework-1.0.0-raw-jar-with-dependencies.jar dump -s "pressure2-120layer.mdj" -n Model
```
